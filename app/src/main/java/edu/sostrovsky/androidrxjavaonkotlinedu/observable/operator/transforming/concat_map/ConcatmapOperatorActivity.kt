package edu.sostrovsky.androidrxjavaonkotlinedu.observable.operator.transforming.concat_map
...
class ConcatmapOperatorActivity : AppCompatActivity() {
    val TAG = "ConcatmapOperatorActivity"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_operator_concatmap)
